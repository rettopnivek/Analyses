...
if ( run_code[3] ) {
  ...
  est = lme4::glmer( cbind( Y, Z ) ~ -1 + Bias + Type + 
                       ( -1 + Bias + Type | Subject ),
                     family = binomial(link = "probit"),
                     data = sim )
...
if ( run_code[4] ) {
  ...
  est = lme4::glmer( cbind( Z, Y ) ~ -1 + 
                       # Group-level effects
                       # Criterion
                       crt_Baseline_0 + crt_Baseline_2 + 
                       crt_Drug_0_2 + crt_Placebo_0_1 + 
                       crt_Placebo_0_2 + 
                       crt_Drug_2_2 + crt_Placebo_2_1 + 
                       crt_Placebo_2_2 +
                       # d'
                       dp_Baseline_0 + dp_Baseline_2 + 
                       dp_Drug_0_2 + dp_Placebo_0_1 + 
                       dp_Placebo_0_2 + 
                       dp_Drug_2_2 + dp_Placebo_2_1 + 
                       dp_Placebo_2_2 + 
