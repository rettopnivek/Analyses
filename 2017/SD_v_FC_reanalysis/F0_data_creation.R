...
rawDat$PrimeDur = 1;
rawDat$PrimeDurLab = .4 # Meaningful label
...
rawDat$Correct = 0
rawDat$CorrectLab = "Left"; # Meaningful label
rawDat$CorrectLab[ rawDat$TaskLab == "Same-different" ] = "Same"
...
rawDat$CorrectLab[ ind & rawDat$CorrectLab == "Left" ] = "Right"
rawDat$CorrectLab[ ind & rawDat$CorrectLab == "Same" ] = "Different"

# Define a dummy-coded variable indicating whether
# the target (1) or foil (0) was primed
rawDat$PrimeType = 0
rawDat$PrimeTypeLab = "Foil-primed" # Meaningful label
ind = rawDat$Condition==0 | rawDat$Condition==1 | 
  rawDat$Condition==2 | rawDat$Condition==3 | 
  rawDat$Condition==8 | rawDat$Condition==9 | 
  rawDat$Condition==10 | rawDat$Condition==11
rawDat$PrimeType[ind] = 1
rawDat$PrimeTypeLab[ind] = "Target-primed"
...
rawDat$ChoiceLab = rawDat$CorrectLab
rawDat$Choice[rawDat$Accuracy==0] = 
  1 - rawDat$Correct[rawDat$Accuracy==0]
rawDat$ChoiceLab[ rawDat$Accuracy == 0 & 
                 rawDat$CorrectLab == "Left" ] = "Right"
rawDat$ChoiceLab[ rawDat$Accuracy == 0 & 
                 rawDat$CorrectLab == "Right" ] = "Left"
rawDat$ChoiceLab[ rawDat$Accuracy == 0 & 
                 rawDat$CorrectLab == "Same" ] = "Different"
rawDat$ChoiceLab[ rawDat$Accuracy == 0 & 
                 rawDat$CorrectLab == "Different" ] = "Same"
